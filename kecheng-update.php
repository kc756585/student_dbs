		            ...
		            <div class="content">
					            ...
					            <div class="controls">
					                      ...
					                      <!-- 增加一个隐藏的input，保存课程编号 -->
					                       ...
					                       <input type="text" id="kcName"  value="<?php echo $row['课程名'] ?>" name="kcName" class="input-large input-fat" placeholder="输入课程名称" data-rules="required|minlength=2|maxlength=10">
					            </div>
					</div>
					<div class="control-group">
					            <label for="inputEmail" class="control-label">课程时间：</label>
					            <div class="controls">
					                       <input type="text" id="kcTime" value="<?php echo $row['时间'] ?>" name="kcTime" class="input-large input-fat"  data-toggle="datepicker-inline" placeholder="输入课程时间">
					            </div>
					</div>
					<div class="control-group">
